...
### Fixed
- **macOS Keychain Prompt**: Fixed annoying keychain permission popup on macOS by adding `--use-mock-keychain` and `--password-store=basic` flags to Chromium launch options
- Users will no longer see "headless_shell wants to use your confidential information" prompt

### Technical
- Updated Playwright browser launch args to prevent system keychain access
